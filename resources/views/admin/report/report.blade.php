        ...
        <div class="panel-body table-responsive">
            ...
            <table cellspacing="0" id="a">
                ...
                <tr>
                  ...
                  -->
                    <td class="green">Yes</td>	<!-- controllo fat_ref -->
                    <td class="green">Yes</td>	<!-- controllo protein_ref -->
                    <td>No</td>					<!-- controllo lactose_ref -->
                    <td>No</td>					<!-- controllo urea_ref -->
                    <td class="green">Yes</td>	<!-- controllo scc_ref -->
                    <td>No</td>					<!-- controllo bhb -->
                </tr>
                <tr>
