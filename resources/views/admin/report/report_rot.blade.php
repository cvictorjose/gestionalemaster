        ...
        <div class="panel-body table-responsive">
            ...
            <table id="header">
                <tr>
                    ...
                    <td class="box">ICAR PT <br />September<br />2017</td>
                </tr>
            </table>
            ...
            <table cellspacing="0" id="a">
                ...
                <tr>
                  ...
                  -->
                    <td class="green">Yes</td>	<!-- controllo fat_rout -->
                    <td class="green">Yes</td>	<!-- controllo protein_rout -->
                    <td>No</td>					<!-- controllo lactose_rout -->
                    <td>No</td>					<!-- controllo urea_rout -->
                    <td class="green">Yes</td>	<!-- controllo bhb -->
                    <td>No</td>					<!-- controllo pag -->
                </tr>
                <tr>
                    ...
                    -->
                    <td>1</td>				<!-- stampo valore di rank quando type = fat_rout -->
                    <td>1</td>				<!-- stampo valore di rank quando type = protein_rout -->
                    <td>&nbsp;</td>			<!-- stampo valore di rank quando type = lactose_rout -->
                    <td>&nbsp;</td>			<!-- stampo valore di rank quando type = urea_rout -->
                    <td>1</td>				<!-- stampo valore di rank quando type = bhb -->
                    <td>&nbsp;</td>			<!-- stampo valore di rank quando type = pag -->
                </tr>
                <tr> </tr>
                <tr> </tr>
                <tr>
            ...
            <table cellspacing="0" id="b">
                ...
                <tr>
                    ...
                    <td style="width:614px;">Deadline: 16/09/2017</td> <!-- prendo la data dal db -->
                </tr>
            </table>
